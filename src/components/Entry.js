...
export default function Entry(){
    const url_link = "https://www.google.com/maps/place/Mount+Fuji/@35.3606421,138.7170637,15z/data=!3m1!4b1!4m6!3m5!1s0x6019629a42fdc899:0xa6a1fcc916f3a4df!8m2!3d35.3606255!4d138.7273634!16zL20vMGNrczA?entry=ttu"
    return(
        <article>
            <div className="main-img-container">        
                <img src="https://scrimba.com/links/travel-journal-japan-image-url" width="100px" alt="main image"/>
            </div>
            <div className="info-container">
                <img src="marker.png" alt ="location marker"/>
                <span>Japan</span>
                <a href={url_link}>View on Google Maps</a>
                <h1>Mount Fuji</h1>
